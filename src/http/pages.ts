...
function renderCueCard(input: {
  ...
  const attrs = later
    ...
    : openOne
      ? `${input.attrs} data-open-one-first="true" data-raise-one-first="true" data-open-after-raise-one-first="true" data-raise-after-open-two-first="true" data-open-after-raise-two-first="true" data-raise-after-open-three-first="true" data-open-after-raise-three-first="true" data-raise-after-open-four-first="true" data-open-after-raise-four-first="true" data-raise-after-open-five-first="true"`
      : input.attrs;
  const body = later
