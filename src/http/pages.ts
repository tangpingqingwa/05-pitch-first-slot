...
function raiseAfterDeckHop(raiseOne: boolean): string {
  if (raiseOne) {
    return `<a class="raise-after-deck raise-one raise-after-open-two raise-after-open-three raise-after-open-four raise-after-open-five" data-raise-after-deck="true" data-raise-one="true" data-raise-after-open-two="true" data-raise-after-open-three="true" data-raise-after-open-four="true" data-raise-after-open-five="true" href="#claim">
          Then Outbid
...
function renderCueCard(input: {
  ...
  const attrs = later
    ...
    : openOne
      ? `${input.attrs} data-open-one-first="true" data-raise-one-first="true" data-open-after-raise-one-first="true" data-raise-after-open-two-first="true" data-open-after-raise-two-first="true" data-raise-after-open-three-first="true" data-open-after-raise-three-first="true" data-raise-after-open-four-first="true" data-open-after-raise-four-first="true" data-raise-after-open-five-first="true" data-open-after-raise-five-first="true"`
      : input.attrs;
  const body = later
